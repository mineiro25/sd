...
o increment ao mesmo tempo e isto acontece várias vezes. Pode até 
acontecer que a thread 2 faça, por exemplo, 3 incrementos de uma vez
depois de a thread 1 ter feito a leitura da variável. Feitos os 3 
incrementos a thread 1 decide continuar, e o valor que ela tinha lido
tinha menos 3 incrementos do que agora, pelo que ela (thread 1) vai 
somar 1 a esse valor e não áquele que a thread 2 originou, guardando esse
valor na variável. 
...
Com isto somos capazes de perceber que foram perdidos 3
incrementos. Então, por exemplo, fazer "java Ex2a 5 1000" devia dar 5000 
mas irá dar algo, como por exemplo, 4532, devido aos incrementos falhados.
